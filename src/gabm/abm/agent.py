...
if TYPE_CHECKING:
    ...
    from gabm.abm.attribute import Gender
...
class Animal(Agent):
    ...
    Attributes:
        ...
        gender (Gender): The gender of the animal (0 is female, 1 is male, 2 is non-binary, None is not set).  
    """
    def __init__(self, agent_id: AgentID, environment: "Environment",
        year_of_birth: int = None, gender: Gender = None):
        """
        ...
        Args:
            ...
            gender: The Gender of the animal. This is a shared attribute that represents demographic characteristics.
        """
    ...
    def get_gender(self) -> str:
        ...
        Return:
            Gender as a string. The mapping is 0: "female", 1: "male", 2: "non-binary", None: "none".
        """
...
class Person(Animal):
    ...
    def __init__(self, agent_id: AgentID, environment: "OpinionatedEnvironment",
        ...
        if opinions is not None:
            for opinion_id, opinion in opinions.items():
                self.opinions[opinion_id] = Opinion(opinion.opinion_id, opinion.opinion_values, opinion.value)
    ...
    def get_opinion(self, opinion_id: OpinionID) -> 'Opinion':
        """
        Args:
    ...
    def set_opinion(self, opinion_id: OpinionID, value: OpinionValue):
        """
